...
public class TeacherServiceTest extends DBTestCase{
	...
	public void backup() throws Exception {
		...
		backupDataSet.addTable("teacher");
	...
	public void testInsertObject() throws Exception {
		...
		teacherService.addTeacher(getTeacher());
		...
		//为DataSet添加student表
		actualDataSet.addTable("teacher");
		
		//从actualDataSet中获取student表作为实际的table
		ITable actualTable = actualDataSet.getTable("teacher");
